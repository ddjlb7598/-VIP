...
-- 创建彩色描边效果函数
local function addRainbowStroke(instance)
...
addRainbowStroke(TextLabel)
addGlowEffect(TextLabel)
...
addRainbowStroke(closebutton)
addGlowEffect(closebutton)
...
mini2.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
